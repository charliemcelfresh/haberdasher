...
import (
	...
	pb "charliemcelfresh/haberdasher/rpc/haberdasher"
...
func (s *Server) HelloWorld(ctx context.Context, none *pb.None) (*pb.Hello, error) {
	return &pb.Hello{Body: "Hello, World!"}, nil
}
