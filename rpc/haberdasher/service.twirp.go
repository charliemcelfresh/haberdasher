...
type Haberdasher interface {
	...
	HelloWorld(context.Context, *None) (*Hello, error)
}
...
func (c *haberdasherProtobufClient) HelloWorld(ctx context.Context, in *None) (*Hello, error) {
	ctx = ctxsetters.WithPackageName(ctx, "haberdasher")
	ctx = ctxsetters.WithServiceName(ctx, "Haberdasher")
	ctx = ctxsetters.WithMethodName(ctx, "HelloWorld")
	caller := c.callHelloWorld
	if c.interceptor != nil {
		caller = func(ctx context.Context, req *None) (*Hello, error) {
			resp, err := c.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*None)
					if !ok {
						return nil, twirp.InternalError("failed type assertion req.(*None) when calling interceptor")
					}
					return c.callHelloWorld(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Hello)
				if !ok {
					return nil, twirp.InternalError("failed type assertion resp.(*Hello) when calling interceptor")
				}
				return typedResp, err
			}
			return nil, err
...
func (c *haberdasherProtobufClient) callHelloWorld(ctx context.Context, in *None) (*Hello, error) {
	out := new(Hello)
...
func (c *haberdasherJSONClient) HelloWorld(ctx context.Context, in *None) (*Hello, error) {
	ctx = ctxsetters.WithPackageName(ctx, "haberdasher")
	ctx = ctxsetters.WithServiceName(ctx, "Haberdasher")
	ctx = ctxsetters.WithMethodName(ctx, "HelloWorld")
	caller := c.callHelloWorld
...
func (c *haberdasherJSONClient) callHelloWorld(ctx context.Context, in *None) (*Hello, error) {
	out := new(Hello)
...
func (s *haberdasherServer) serveHelloWorld(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *haberdasherServer) serveHelloWorldJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "HelloWorld")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
	...
	handler := s.Haberdasher.HelloWorld
	if s.interceptor != nil {
		handler = func(ctx context.Context, req *None) (*Hello, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					typedReq, ok := req.(*None)
					if !ok {
					...
					return s.Haberdasher.HelloWorld(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Hello)
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *Hello and nil error while calling HelloWorld. nil responses are not supported"))
		return
	}
...
func (s *haberdasherServer) serveHelloWorldProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "HelloWorld")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
